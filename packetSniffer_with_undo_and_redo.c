    ...
    {
	    int flag,isFolderPresent;//flag is -1 for "undo" ,1 for "redo",2 for "do"
	    char folder[256];
    }operation;
    ...
    {	int z=0,i;
      ...
      if(destPort==60000)//60000 port no. for redo operation
	    {	z=1;
		    //printf("Received a redo packet...............\n");
		    for(i=9;i>=0;i--)
		    {
	    ...
	    else if(destPort==60001)//60001 port no. for undo operation
	    {	z=1;
		    //printf("Received an undo packet.............\n");
		    for(i=9;i>=0;i--)
		    {
		    	if(history[i].flag==2 && history[i].isFolderPresent)
    			{	
    	...
    	else if(destPort==60002)//do packet
	    {	z=1;
		    char str[5];
		    history[hisNo].flag=2;
		    history[hisNo].isFolderPresent=1;
		    sprintf(str,"%d", folderNo);
		    char str1[50]="/home/gomathi/pSniff/Folder";
		    strcpy(history[hisNo].folder,strcat(str1,str));
	    ...
	    if(z==1 && hisNo>9)
	    {
		    for(i=9;i>=1;i--)
	    	{
			    ...
			    history[i-1].isFolderPresent=history[i-1].isFolderPresent;
